...
#lf If you come from bash you might have to change your $PATH.
...
# Example format: plugins=srails git textmate ruby lighthouse)
# Add wisely, as too many plugins slow down shell startup.
plugins=(zsh-autosuggestions zsh-completions zsh-syntax-highlighting bgnotify zsh-dircolors-nord)
...
#ºalias la="exa -lgha --icons --group-directories-first"
